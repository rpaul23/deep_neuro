...
def plot_areas(decoders, intervals, sessions, alevels):
        ...
        for count, phase in enumerate(intervals):
            for alevel in alevels:
                for session in sessions:
                    ...
                    # Paths
                    system_path = '/Users/jannes/Projects/Marseille/'
                    raw_path = system_path + 'data/raw/'
                    results_path = system_path + 'cluster/results/'

                    elecs_path = (raw_path
                                  + 'brainmap/lucy_xy_coordinates_wholebrain.mat')
